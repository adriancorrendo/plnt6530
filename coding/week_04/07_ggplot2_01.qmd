...
p_load("gganimate", "magick", "gifski") # animations
```
...
years_colors <- c("1999" = "#1e6091", "2001" = "#9b2226")
```
...
corn_data %>% 
  ...
  geom_histogram(aes(fill = Year)) # add histogram layer with Year colors
```

### ii. Add more layers and labels
