...
- **performance**: provides `check_model()` for a compact, friendly set of diagnostic plots (assumptions + influential observations) that works across many model classes.  [https://cran.r-project.org/package=performance](https://cran.r-project.org/package=performance)
